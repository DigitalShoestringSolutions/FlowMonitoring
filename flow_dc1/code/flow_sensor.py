...
class WaterFlowSensor:
    ...
    #     flow_rate = (self.count / 476) / 60  # Assuming 476 pulses per liter
    #     self.count = 0  # Reset pulse counter
    #     return flow_rate

    def calculate_flow_rate(self):
        #logic: 450 fan rotations in 1000ml (for min 1L). 1 rotation in 1000/450 ml. Similarly, 2000/4.45 ml in 1 rotation for this 1 inch sensor here.
        flow_rate = (self.count * 4.45 * 60) / 1000  # Assuming 476 pulses per liter...gives L/min
        self.count = 0  # Reset pulse counter
        return flow_rate
